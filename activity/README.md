...
| 0020 | [e04-c2-diagnostic](0020-e04-c2-diagnostic.md) | **E0.4 completes Phase 0.** Binding must be value-aware (33.5% of bound slots had wrong values); pooled conditional Simpson-confounded; stratified lift **+0.102 Qwen, ~0 on Gemmas** |
| 0021 | [length-truncation-artefact-the-definitive-version](0021-length-truncation-artefact-the-definitive-version.md) | **3rd length correction, now on complete answers.** Underproduction is **Qwen-specific (−22%), Gemmas on-target**; 0019's "universal" was a 2000-char storage cap |
| 0022 | [e41-prior-battery-the-collision-test](0022-e41-prior-battery-the-collision-test.md) | **First direct test of the core mechanism — largely negative.** Taxonomy priors mostly don't reproduce as collisions; surfacing helped 1×, hurt 2×, null else. Failures are counting, not prior-override |
| 0023 | [blindness-audit-16-agents](0023-blindness-audit-16-agents.md) | 16 parallel agents audited the checkers on 2,880 gens. Postscript check wrong on 19% of ps_recase items (92 false-FAIL, 10 false-PASS); case/length/bullets matched. Changed 2 E4.1 effects |
| 0024 | [contradiction-test-is-the-spec-causal](0024-contradiction-test-is-the-spec-causal.md) | **Fixes E4.1's design.** Injected spec on a neutral dimension controls output ~100% (spec IS causal), but is subordinate to an explicit system rule; weakest model is capability-ordered |
| 0025 | [the-abc-triangle-execution-not-binding](0025-the-abc-triangle-execution-not-binding.md) | **Said A / thought B / did C** from E0.4: dominant failure is **declared-right-did-wrong (execution)**, not the default winning the declaration. Corrects 0024 |
| 0026 | [e04-contradiction-metrics](0026-e04-contradiction-metrics.md) | Declared spec contradicts the ask **9–13%** of constraints (17–28% of declared); contradiction is minority vs omission; case-default-capture is weak-model |
| 0027 | [deviations-from-design](0027-deviations-from-design.md) | Diff between the pre-registered design and what was run: typed→NL spec, model substitution, schema growth, two-phase elicitation, value-aware binding, temp 1.0, etc. |
